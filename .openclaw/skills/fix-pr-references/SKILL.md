...
Para cada PR, o campo `commits` já traz a lista de OIDs de commit pertencentes àquele PR (via API do GitHub), incluindo os que foram _squashed_ (nesse caso, o PR pode ter só o commit final — Claude trata isso separadamente, ver passo 5).
